...
adb shell rm -rf /sdcard/Android/data/com.pubg.krmobile-1/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate > nul 2>&1
...
adb shell mkdir /data/data/com.pubg.krmobile-1/shared_prefs > nul 2>&1
adb shell chmod -R 777 /data/data/com.pubg.krmobile/shared_prefs > nul 2>&1
adb shell chmod -R 777 /data/data/com.pubg.krmobile-1/shared_prefs > nul 2>&1
adb shell rm -rf /data/data/com.pubg.krmobile/databases/* > nul 2>&1
adb shell rm -rf /data/data/com.pubg.krmobile-1/databases/* > nul 2>&1
...
adb shell mv /data/data/com.pubg.krmobile-1/shared_prefs/device_id3.xml /data/data/com.pubg.krmobile-1/shared_prefs/device_id.xml > nul 2>&1
...
adb shell touch /sdcard/Android/data/com.pubg.krmobile-1/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate > nul 2>&1
goto resume2
