...
adb push %TEMP%\device_id.xml /data/data/com.tencent.ig-1/shared_prefs
...
adb shell rm -rf /data/data/com.tencent.ig-1/databases > nul 2>&1
...
adb shell rm -rf /data/data/com.tencent.ig-1/files/.system_android_l2 > nul 2>&1
adb shell rm -rf /sdcard/Android/data/com.tencent.ig/files/.system_android_l2 > nul 2>&1
adb shell rm -rf /sdcard/Android/data/com.tencent.ig-1/files/.system_android_l2 > nul 2>&1
...
adb shell rm -rf /sdcard/Android/data/com.tencent.ig-1/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig/shared_prefs > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig-1/shared_prefs > nul 2>&1
adb shell mkdir /data/data/com.tencent.ig/shared_prefs > nul 2>&1
adb shell mkdir /data/data/com.tencent.ig-1/shared_prefs > nul 2>&1
adb shell chmod -R 777 /data/data/com.tencent.ig/shared_prefs > nul 2>&1
adb shell chmod -R 777 /data/data/com.tencent.ig-1/shared_prefs > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig/databases/* > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig-1/databases/* > nul 2>&1
...
adb shell mv /data/data/com.tencent.ig-1/shared_prefs/device_id3.xml /data/data/com.tencent.ig-1/shared_prefs/device_id.xml > nul 2>&1
...
adb shell touch /sdcard/Android/data/com.tencent.ig-1/files/UE4Game/ShadowTrackerExtra/ShadowTrackerExtra/Intermediate > nul 2>&1
goto resume2
