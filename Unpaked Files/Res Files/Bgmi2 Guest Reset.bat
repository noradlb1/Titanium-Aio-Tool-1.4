...
adb shell rm -rf /data/data/com.pubg.imobile/cache/* > nul 2>&1
adb shell rm -rf /data/data/com.pubg.imobile-1/cache/* > nul 2>&1
adb shell rm -rf /data/data/com.pubg.imobilecode_cache/* > nul 2>&1
adb shell rm -rf /data/data/com.pubg.imobile-1/code_cache/* > nul 2>&1
...
adb shell rm -rf /sdcard/Android/data/com.pubg.imobile/cache/* > nul 2>&1
adb shell rm -rf /sdcard/Android/data/com.pubg.imobile-1/cache/* > nul 2>&1
