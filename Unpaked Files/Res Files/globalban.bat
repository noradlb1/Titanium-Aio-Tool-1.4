...
adb shell rm -rf /data/data/com.tencent.ig-1/cache/* > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig/code_cache/* > nul 2>&1
adb shell rm -rf /data/data/com.tencent.ig-1/code_cache/* > nul 2>&1
...
adb shell rm -rf /sdcard/Android/data/com.tencent.ig-1/cache/* > nul 2>&1
